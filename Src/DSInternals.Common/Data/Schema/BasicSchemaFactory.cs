namespace DSInternals.Common.Data
{
    ...
    public static class BasicSchemaFactory
    {
        public static BasicSchema CreateSchema()
        {
            ...
            attributes.Add((ISchemaAttribute)new BasicSchemaAttribute(CommonDirectoryAttributes.MemberOfID, CommonDirectoryAttributes.MemberOf, AttributeSyntax.String));
